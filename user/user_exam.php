...
$stmt = $conn->prepare("SELECT * FROM exam_tbl WHERE exam_id = ?");
    ...
    <div class="app-main__inner">
        ...
        <div class="col-md-12 p-0 mb-4">
            <form method="post" id="submitAnswerFrm">
                <input type="hidden" name="ex_id" id="ex_id" value="<?php echo $examId; ?>">
                <input type="hidden" name="examAction" id="examAction">
                <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                    <?php 
                    // Query to select questions
                    $selQuest = $conn->query("SELECT * FROM exam_question_tbl WHERE ex_id='$examId' ORDER BY RAND() LIMIT $exDisplayLimit");
